...
<html lang="en">
    ...
    <body>
        ...
        <section class="terms" id="terms">
            <h1 class="head1">Terms and Conditions</h1>
            <div class="content">
                <p>
                    ...
                    18 years of age or older. Changes or cancellations are not permitted within 
                    48 hours of departure. No-shows will be charged in full with no refunds. 
                    SOWOOZOO reserves the right to combine different length flights and all times 
                    are approximate. Excursions require a minimum number of passengers to operate.
                </p>
                <p>
                    The maximum weight limit per person is 300 lbs. / 136 kilos / 21 stone. 
                    Guests exceeding the weight limit will be required to purchase an additional 
                    comfort seat. The 7-passenger weight limit may not exceed 1,240 lbs. per 
                    helicopter and may be less depending on departure location and season. 
                    Guests with inaccurately stated weights may be canceled with no refund.
                </p>
                <p>
                    Children two years of age or older will be required to purchase a seat. 
                    Children under two years of age with proper identification can travel on an adult’s lap. 
                    Times stated "hotel to hotel" include estimated ground transportation duration.
                </p>
                <p>
                    For landing flights, we strongly recommend comfortable clothing and stable shoes that 
                    are appropriate for walking on rocky and uneven ground.
                </p>
            </div>
        </section>
        <!-- End terms section -->
        ...
        <section class="contact" id="contact">
            <div class="content">
                ...
                <form action="termandcondition.php" method="POST">
