    ...
    <body>
       <!-- header section -->
        ...
        <section class="booking" id="booking">
            <div class="content">
                <h1 class="head1">Payment Details</h1>
                
                <form action="payment.php" method="POST">
                    <label>Card holder</label><br><input type="text" name="Name" placeholder="Your name" id="" required class="text"><br>
                    <label for="ccn">Card number</label>
                    <input id="ccn" type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx" required class="text">
                    
                    <div class="row">
                        <div class="column left">
                            <label>Expiry date</label>
                            <input type="text" pattern="[0-9]+"  placeholder="MM YY" name="expiry" id="expiry" maxlength='7' required class="text" />
                            
                        </div>
                        <div class="column right">
                            <label>CVV</label><br>
                            <input type="tel" pattern="[0-9]+" id="phone" name="phone" required placeholder="cvv" maxlength="3" class="text"><br>
                        </div>
                    </div>
