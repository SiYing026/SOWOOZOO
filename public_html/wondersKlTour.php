    ...
    <body>
        ...
        <section class="information" id="information">
            <h1 class="head1">
                <?php
                    if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                        $sql="SELECT name FROM packages WHERE id=5";
            ...
            <video controls autoplay>
                <?php
                    if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                        $sql="SELECT video FROM packages WHERE id=5";
                        $result = mysqli_query($dbc,$sql);
                        while($row = mysqli_fetch_assoc($result)){
            ...
            <section class="details" id="details">
                <div class="content">
                    ...
                    <?php
                        if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                            $sql="SELECT price FROM packages WHERE id=5";
                            $result = mysqli_query($dbc,$sql);
                            while($row = mysqli_fetch_assoc($result)){
                                    echo "From: {$row['price']}";
                            }
                    ...
                    <?php
                        if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                            $sql="SELECT description FROM packages WHERE id=5";
                            $result = mysqli_query($dbc,$sql);
                            while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="content">
                    <div class="infobox">
                        <div class="highlight">
                            ...
                            <?php
                                if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                                    $sql="SELECT tourHighlights FROM packages WHERE id=5";
                                    $result = mysqli_query($dbc,$sql);
                                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <div class="highlight">
                            ...
                            <?php
                                if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                                    $sql="SELECT tourInfo FROM packages WHERE id=5";
                                    $result = mysqli_query($dbc,$sql);
                                    while($row = mysqli_fetch_assoc($result)){
                                            echo "{$row['tourInfo']}";
                                    }
                        ...
                        <div class="highlight">
                            ...
                            <table>
                                <?php
                                    if ($dbc = mysqli_connect('localhost','root','','sowoozoo')){
                                        $sql="SELECT addInfo FROM packages WHERE id=5";
                                        $result = mysqli_query($dbc,$sql);
                                        while($row = mysqli_fetch_assoc($result)){
                                                echo "{$row['addInfo']}";
                                        }
        ...
        <section class="contact" id="contact">
            <div class="content">
                ...
                <form action="wondersKlTour.php" method="POST">
