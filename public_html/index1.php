...
<html lang="en">
   ...
   <section class="gallery" id="gallery">
        ...
        <h1 class="heading">Traveler Collection</h1>
        
    <div class="slideshow-container">

        <div class="mySlides fade">
          <img src="images/collection_1.jpg" style="width:100%">
          <div class="desp"><strong>KL Tower</strong><br>The 7<sup>th</sup> tallest telecommunications tower in the world</div>
        </div>

        <div class="mySlides fade">
          <img src="images/collection_2.jpg" style="width:100%">
          <div class="desp"><strong>Kuala Lumpur City Centre</strong><br> The world's tallest twin skyscrapers</div>
        </div>
        
        <div class="mySlides fade">
          <img src="images/collection_3.jpg" style="width:100%">
          <div class="desp"><strong>Independence Square</strong><br> The Union Flag was lowered and the Malaysian flag hoisted for the first time</div>
          
        </div>

        <div class="mySlides fade">
          <img src="images/collection_4.jpg" style="width:100%">
          <div class="desp"><strong>Malaysia National Palace</strong><br> The official residence of the Yang di-Pertuan Agong</div>
        </div>
        
        <div class="mySlides fade">
          <img src="images/collection_5.jpg" style="width:100%">
          <div class="desp"><strong>Kuala Lumpur Environment</strong></div>
        </div>
        
        <div class="mySlides fade">
          <img src="images/collection_6.jpg" style="width:100%">
          <div class="desp"><strong>Kuala Lumpur Environment</strong></div>
        </div>
        
        <div class="mySlides fade">
          <img src="images/collection_7.jpg" style="width:100%">
          <div class="desp"><strong>Kuala Lumpur Environment</strong></div>
        </div>
